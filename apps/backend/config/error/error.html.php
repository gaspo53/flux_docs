    ...
    <div id="wrap">
      ...
      <div class="container">
        <div class="page-header">
          <h1 class="alert alert-error">Sorry!! There was an error</h1>
        </div>
        <p class="lead">Please back and try the operation again. Also, check the lack of the <b>cache/</b> and <b>log/</b> folders.</p>
      </div>
