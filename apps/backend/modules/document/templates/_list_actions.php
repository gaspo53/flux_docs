      ...
      <table class="table" cellspacing="0">
        <tbody>
          <?php foreach ($configuration->getFormFilterFields($filters) as $name => $field): ?>
            ...
            <?php
            include_partial('document/filters_field_modal', array(
                'name' => $name,
...
<div class="modal hide" id="documentDetailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
