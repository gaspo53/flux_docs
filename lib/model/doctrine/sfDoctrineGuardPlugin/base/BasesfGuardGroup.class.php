 ...
 * @property Doctrine_Collection $GroupDocuments
 * 
 ...
 * @method Doctrine_Collection getGroupDocuments()         Returns the current record's "GroupDocuments" collection
 ...
 * @method sfGuardGroup        setGroupDocuments()         Sets the current record's "GroupDocuments" collection
 * 
 * @package    flux_docs
 * @subpackage model
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Document as GroupDocuments', array(
             'local' => 'id',
             'foreign' => 'group_id'));
